...
// ── The run-marker WIRING (pharn/floor/run-marker.mjs, 6.23.0, D3) ─────────────────────────────────────
//
...
//
// WHY IT EXISTS (P7 — the recorded trigger). Since 6.23.0 `enforce-writes-scope.cjs`'s no-scope default
