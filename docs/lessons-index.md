...
61 lessons · 61 tagged · 0 malformed · 0 untagged · ~44160 tokens total
...
L61 | floor    | refusal-path,untrusted-input,total-function,crash-as-verdict,fail-closed                       | A value quoted into a refusal reason must go through a function that cannot throw — `String(v)` throws on parsed JSON, and a refusal that throws is read as a verdict | 2026-09-25 | ~658
```
