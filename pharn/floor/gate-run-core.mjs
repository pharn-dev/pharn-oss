...
// LAST, for every verify run (since 6.24.0 through pharn/floor/stage-verify.mjs, which the thin /pharn-verify pins).
//
 ...
 *  6.23.0's stage-regress-script and 6.24.0's stage-verify-script moved the discovery LOGIC into tested code,
 ...
 *  applies when it chooses which expected paths to hand in (6.24.0).
