...
writes: ["pharn/features/<name>/lenses/secrets-in-code/findings.json"]
...
`pharn/features/secrets-in-code/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md`
