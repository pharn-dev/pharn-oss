...
writes: ["pharn/features/<name>/lenses/missing-await/findings.json"]
...
`pharn/features/missing-await/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission (the
