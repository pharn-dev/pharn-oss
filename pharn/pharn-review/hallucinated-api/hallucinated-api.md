...
writes: ["features/<name>/lenses/hallucinated-api/findings.json"]
...
`features/hallucinated-api/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md`
