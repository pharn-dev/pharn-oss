...
writes: ["pharn/features/<name>/lenses/unsafe-deserialization/findings.json"]
...
`pharn/features/unsafe-deserialization/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md`
