...
writes: ["pharn/features/<name>/lenses/missing-timeout/findings.json"]
...
`pharn/features/missing-timeout/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission (the
