...
writes: ["pharn/features/<name>/lenses/null-deref/findings.json"]
...
`pharn/features/null-deref/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission (the
