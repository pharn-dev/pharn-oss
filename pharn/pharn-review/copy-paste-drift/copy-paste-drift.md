...
writes: ["pharn/features/<name>/lenses/copy-paste-drift/findings.json"]
...
`pharn/features/copy-paste-drift/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission
