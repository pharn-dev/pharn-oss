...
writes: ["features/<name>/lenses/trust-fence/findings.json"]
...
`features/trust-fence/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md`
