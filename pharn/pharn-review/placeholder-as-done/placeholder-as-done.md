...
writes: ["pharn/features/<name>/lenses/placeholder-as-done/findings.json"]
...
`pharn/features/placeholder-as-done/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md`
