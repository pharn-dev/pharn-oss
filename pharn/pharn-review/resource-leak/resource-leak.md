...
writes: ["pharn/features/<name>/lenses/resource-leak/findings.json"]
...
`pharn/features/resource-leak/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission (the
