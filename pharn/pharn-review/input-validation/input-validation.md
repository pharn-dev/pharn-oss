...
writes: ["pharn/features/<name>/lenses/input-validation/findings.json"]
...
`pharn/features/input-validation/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md`
