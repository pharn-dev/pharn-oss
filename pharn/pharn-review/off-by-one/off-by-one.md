...
writes: ["pharn/features/<name>/lenses/off-by-one/findings.json"]
...
`pharn/features/off-by-one/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission (the
