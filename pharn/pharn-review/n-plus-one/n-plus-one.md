...
writes: ["pharn/features/<name>/lenses/n-plus-one/findings.json"]
...
`pharn/features/n-plus-one/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission (the
