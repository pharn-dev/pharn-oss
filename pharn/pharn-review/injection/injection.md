...
writes: ["pharn/features/<name>/lenses/injection/findings.json"]
...
`pharn/features/injection/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission (the
