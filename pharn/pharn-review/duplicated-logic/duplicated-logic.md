...
writes: ["pharn/features/<name>/lenses/duplicated-logic/findings.json"]
...
`pharn/features/duplicated-logic/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission
