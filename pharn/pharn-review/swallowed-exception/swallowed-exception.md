...
writes: ["pharn/features/<name>/lenses/swallowed-exception/findings.json"]
...
`pharn/features/swallowed-exception/findings.json` — the JSON array defined by `pharn/pharn-contracts/finding-shape.md` §Emission
