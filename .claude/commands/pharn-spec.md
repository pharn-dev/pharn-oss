...
## `--quick` (6.24.0) — a mini-SPEC for `/pharn-ship --quick`
...
`template`, `spec-kind` or `quick` (6.24.0 — a quick SPEC with more than three criteria, or one verified at a
